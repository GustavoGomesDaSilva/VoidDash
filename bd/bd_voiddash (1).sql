...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27/05/2023 às 19:43
...
--
CREATE DATABASE IF NOT EXISTS `bd_voiddash` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bd_voiddash`;
...
--
-- Criação: 25/05/2023 às 16:28
-- Última atualização: 26/05/2023 às 14:21
--
...
--
-- Criação: 26/05/2023 às 14:23
-- Última atualização: 26/05/2023 às 17:52
--
...
--
-- RELACIONAMENTOS PARA TABELAS `motoristas`:
--
...
--
-- RELACIONAMENTOS PARA TABELAS `registros`:
--   `matricula`
...
CREATE TABLE `sinistros` (
  ...
  `matricula` varchar(5) NOT NULL,
  `placa` varchar(8) NOT NULL,
  `idRegistros` int(11) DEFAULT NULL,
...
--
-- RELACIONAMENTOS PARA TABELAS `sinistros`:
--   `matricula`
--       `motoristas` -> `matricula`
--   `placa`
--       `carros` -> `placa`
...
ALTER TABLE `sinistros`
  ...
  ADD KEY `fkRegistrosSinistros` (`idRegistros`),
  ADD KEY `fkPlacaSinistros` (`placa`),
  ADD KEY `fkMatriculaSinistros` (`matricula`);
...
--
ALTER TABLE `sinistros`
  ADD CONSTRAINT `fkMatriculaSinistros` FOREIGN KEY (`matricula`) REFERENCES `motoristas` (`matricula`),
  ADD CONSTRAINT `fkPlacaSinistros` FOREIGN KEY (`placa`) REFERENCES `carros` (`placa`),
  ADD CONSTRAINT `fkRegistrosSinistros` FOREIGN KEY (`idRegistros`) REFERENCES `registros` (`idRegistro`);
COMMIT;
